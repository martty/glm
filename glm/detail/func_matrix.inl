...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER static mat<C, R, T> call(mat<C, R, T> const& x, mat<C, R, T> const& y)
		{
			mat<C, R, T> Result;
	...
	{
		GLM_FUNC_QUALIFIER static mat<2, 2, T> call(mat<2, 2, T> const& m)
		{
			mat<2, 2, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<3, 2, T> call(mat<2, 3, T> const& m)
		{
			mat<3,2, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<4, 2, T> call(mat<2, 4, T> const& m)
		{
			mat<4, 2, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<2, 3, T> call(mat<3, 2, T> const& m)
		{
			mat<2, 3, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<3, 3, T> call(mat<3, 3, T> const& m)
		{
			mat<3, 3, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<4, 3, T> call(mat<3, 4, T> const& m)
		{
			mat<4, 3, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<2, 4, T> call(mat<4, 2, T> const& m)
		{
			mat<2, 4, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<3, 4, T> call(mat<4, 3, T> const& m)
		{
			mat<3, 4, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static mat<4, 4, T> call(mat<4, 4, T> const& m)
		{
			mat<4, 4, T> Result;
			Result[0][0] = m[0][0];
			Result[0][1] = m[1][0];
	...
	{
		GLM_FUNC_QUALIFIER static T call(mat<2, 2, T> const& m)
		{
	...
	{
		GLM_FUNC_QUALIFIER static T call(mat<3, 3, T> const& m)
		{
			return
	...
	{
		GLM_FUNC_QUALIFIER static T call(mat<4, 4, T> const& m)
		{
	...
	GLM_FUNC_QUALIFIER mat<C, R, T> matrixCompMult(mat<C, R, T> const& x, mat<C, R, T> const& y)
	{
	...
	GLM_FUNC_QUALIFIER typename detail::outerProduct_trait<DA, DB, T>::type outerProduct(vec<DA, T> const& c, vec<DB, T> const& r)
	{
	...
	template<length_t C, length_t R, typename T>
	GLM_FUNC_QUALIFIER typename mat<C, R, T>::transpose_type transpose(mat<C, R, T> const& m)
	{
	...
	template<length_t C, length_t R, typename T>
	GLM_FUNC_QUALIFIER T determinant(mat<C, R, T> const& m)
	{
	...
	template<length_t C, length_t R, typename T>
	GLM_FUNC_QUALIFIER mat<C, R, T> inverse(mat<C, R, T> const& m)
	{
