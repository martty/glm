...
#	if GLM_CONFIG_DEFAULTED_FUNCTIONS == GLM_DISABLE
		template<typename T>
		GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat()
...
#	endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<4, 4, T> const& m)
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(T const& s)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(col_type const& v0, col_type const& v1, col_type const& v2, col_type const& v3)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(vec<4, V1> const& v1, vec<4, V2> const& v2, vec<4, V3> const& v3, vec<4, V4> const& v4)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<2, 2, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<3, 3, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<2, 3, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<3, 2, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<2, 4, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<4, 2, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], 0, 0), col_type(m[1], 0, 0), col_type(0, 0, 1, 0), col_type(0, 0, 0, 1)}
#		endif
	{
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<3, 4, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T>::mat(mat<4, 3, T> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T>
	GLM_FUNC_QUALIFIER typename mat<4, 4, T>::col_type & mat<4, 4, T>::operator[](typename mat<4, 4, T>::length_type i)
	{
	...
	template<typename T>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 4, T>::col_type const& mat<4, 4, T>::operator[](typename mat<4, 4, T>::length_type i) const
	{
		assert(i < this->length());
		return this->value[i];
	}
	...
	template<typename T>
	template<typename U>
	GLM_FUNC_QUALIFIER mat<4, 4, T>& mat<4, 4, T>::operator=(mat<4, 4, U> const& m)
	{
	...
	template<typename T>
	template<typename U>
	GLM_FUNC_QUALIFIER mat<4, 4, T>& mat<4, 4, T>::operator+=(U s)
	{
		this->value[0] += s;
		this->value[1] += s;
		this->value[2] += s;
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T> operator+(mat<4, 4, T> const& m)
	{
		return m;
	}
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T> operator+(mat<4, 4, T> const& m, T const& s)
	{
		return mat<4, 4, T>(
			m[0] + s,
			m[1] + s,
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T> operator+(T const& s, mat<4, 4, T> const& m)
	{
		return mat<4, 4, T>(
			m[0] + s,
			m[1] + s,
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<4, 4, T> operator+(mat<4, 4, T> const& m1, mat<4, 4, T> const& m2)
	{
		return mat<4, 4, T>(
			m1[0] + m2[0],
			m1[1] + m2[1],
	...
	template<typename T>
	GLM_FUNC_QUALIFIER typename mat<4, 4, T>::col_type operator*
	(
		mat<4, 4, T> const& m,
...
*/
	...
	template<typename T>
	GLM_FUNC_QUALIFIER typename mat<4, 4, T>::row_type operator*
	(
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<2, 4, T> operator*(mat<4, 4, T> const& m1, mat<2, 4, T> const& m2)
	{
		return mat<2, 4, T>(
	...
	template<typename T>
	GLM_FUNC_QUALIFIER mat<3, 4, T> operator*(mat<4, 4, T> const& m1, mat<3, 4, T> const& m2)
	{
		return mat<3, 4, T>(
			m1[0][0] * m2[0][0] + m1[1][0] * m2[0][1] + m1[2][0] * m2[0][2] + m1[3][0] * m2[0][3],
			m1[0][1] * m2[0][0] + m1[1][1] * m2[0][1] + m1[2][1] * m2[0][2] + m1[3][1] * m2[0][3],
	...
	template<typename T>
	GLM_FUNC_QUALIFIER typename mat<4, 4, T>::col_type operator/(mat<4, 4, T> const& m, typename mat<4, 4, T>::row_type const& v)
	{
		return inverse(m) * v;
	}

	template<typename T>
	GLM_FUNC_QUALIFIER typename mat<4, 4, T>::row_type operator/(typename mat<4, 4, T>::col_type const& v, mat<4, 4, T> const& m)
	{
		return v * inverse(m);
	}
	...
	template<typename T>
	GLM_FUNC_QUALIFIER bool operator==(mat<4, 4, T> const& m1, mat<4, 4, T> const& m2)
	{
