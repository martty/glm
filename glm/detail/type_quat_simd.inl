...
/*
	...
	{
		static qua<float> call(qua<float> const& q1, qua<float> const& q2)
		{
...
*/
	...
	{
		static qua<float> call(qua<float> const& q, qua<float> const& p)
		{
			qua<float> Result;
...
#	if GLM_ARCH & GLM_ARCH_AVX_BIT
	...
	{
		static qua<double> call(qua<double> const& a, qua<double> const& b)
		{
			qua<double> Result;
...
#	endif
	...
	{
		static qua<float> call(qua<float> const& q, float s)
		{
			vec<4, float> Result;
...
#	if GLM_ARCH & GLM_ARCH_AVX_BIT
	...
	{
		static qua<double> call(qua<double> const& q, double s)
		{
			qua<double> Result;
...
#	endif
	...
	{
		static vec<4, float> call(qua<float> const& q, vec<4, float> const& v)
		{
