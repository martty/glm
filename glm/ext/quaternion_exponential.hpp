...
namespace glm
{
	...
	template<typename T>
	GLM_FUNC_DECL qua<T> exp(qua<T> const& q);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T>
	GLM_FUNC_DECL qua<T> log(qua<T> const& q);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T>
	GLM_FUNC_DECL qua<T> pow(qua<T> const& q, T y);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T>
	GLM_FUNC_DECL qua<T> sqrt(qua<T> const& q);
