...
namespace glm
{
	...
	GLM_FUNC_DECL mat<C, R, T> flipud(mat<C, R, T> const& in);

	/// Flips the matrix columns right and left.
	///
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename T>
	GLM_FUNC_DECL mat<C, R, T> fliplr(mat<C, R, T> const& in);
	...
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename T>
	GLM_FUNC_DECL void qr_decompose(mat<C, R, T> const& in, mat<(C < R ? C : R), R, T>& q, mat<C, (C < R ? C : R), T>& r);
	...
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename T>
	GLM_FUNC_DECL void rq_decompose(mat<C, R, T> const& in, mat<(C < R ? C : R), R, T>& r, mat<C, (C < R ? C : R), T>& q);
